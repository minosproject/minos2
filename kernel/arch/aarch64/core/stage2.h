...
#define S2_PAGE_NC			(S2_DES_PAGE | S2_AF | S2_SH_INNER | S2_MEMATTR_DEV_nGnRE)
#define S2_PAGE_WC			(S2_DES_PAGE | S2_AF | S2_SH_INNER | S2_MEMATTR_NORMAL_NC)
...
#define S2_BLOCK_NC			(S2_DES_BLOCK | S2_AF | S2_SH_INNER | S2_MEMATTR_DEV_nGnRE)
#define S2_BLOCK_DEVICE			(S2_DES_BLOCK | S2_AF | S2_SH_OUTER | S2_MEMATTR_DEV_nGnRnE | S2_XN)
#define S2_BLOCK_WC			(S2_DES_BLOCK | S2_AF | S2_SH_OUTER | S2_MEMATTR_NORMAL_NC)
